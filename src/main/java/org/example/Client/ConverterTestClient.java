...
public class ConverterTestClient {
    public static void main(String[] args) {
        // Added on August 21, 2024 to ask for user input
        Scanner input = new Scanner(System.in);
        System.out.println("Please Enter Your message: ");
        String message = input.nextLine();

        ManagedChannel managedChannel = ManagedChannelBuilder
                .forAddress("localhost", 9090) // grpc.port=8484 later
                .usePlaintext()
                .build();
        ...
        RequestText request = RequestText.newBuilder()
                ...
                .build();
        // RequestText request = RequestText.newBuilder()
        //                .setInputText("grpc")  // .setInputText("grpc") using input
        //                .build();

        RequestText request2 = RequestText.newBuilder()
                .setInputText("the first character should be capitalized")
                .build();
